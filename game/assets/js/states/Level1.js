...
Level1.prototype = {
  ...
  create: function () {
    ...
    new MoonMage.entities.ui.TextBox(this.game, '→', 80, 380);
    new MoonMage.entities.ui.TextBox(this.game, '↑', 535, 380);
    new MoonMage.entities.ui.TextBox(this.game, "'space'  &  ← ↑ →", 1300, 380);
